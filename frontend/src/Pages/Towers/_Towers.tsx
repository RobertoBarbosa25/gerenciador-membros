...
//       movedPlayer = sourcePlayers.splice(source.index, 1)[0]; // Remove o jogador da lista de todos
//       setAllPlayers(sourcePlayers);

//       if (movedPlayer) {
//         if (destination.droppableId === 'attackTower') {
//           setAttackTower((prev) => {
//             const newAttackTower = [...prev, movedPlayer]; // Adiciona jogador à torre de ataque
...
//             const newDefenseTower = [...prev, movedPlayer]; // Adiciona jogador à torre de defesa
...
//             <TableContainer component={Paper} style={{ height: '100%', overflowY: 'auto', width: "100% !important" }}>
//               <Table>
//                 <TableHead>
//                   <TableRow>
